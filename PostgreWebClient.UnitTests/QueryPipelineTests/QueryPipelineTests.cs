...
public partial class QueryPipelineTests
{
    ...
    [Theory, AutoMoqData]
    public void HandleQuery_CommandServiceInvoke_SetTableInResult([Frozen] Mock<ICommandService> command,
    ...
    public void HandleQuery_DatabaseInfoServiceInvoke_SetDatabaseInfoInResult(
        [Frozen] Mock<IDatabaseInfoService> databaseInfo, QueryPipelineService sut)
    {
        // arrange
